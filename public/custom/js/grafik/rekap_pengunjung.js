...
$( document ).ready(function(){
    var data_grid = $('#table-rekap-pengunjung').DataTable({
          "paging": true,
          "lengthChange": true,
          "searching": false,
          "ordering": false,
          ...
          "ajax" : {
            "url" : global_url+"rekapitulasi/getDataRekapPengunjung/",
            "type" : "POST",
...
function exportExcel(){
    var urlDownload = global_url+"rekapitulasi/downloadExcel/rekap-pengunjung/";
