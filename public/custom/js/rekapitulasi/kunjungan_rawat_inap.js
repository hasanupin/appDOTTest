...
$( document ).ready(function(){
    var data_grid = $('#table-jumlah-pengunjung-rawat-inap').DataTable({
          "paging": true,
          "lengthChange": false,
          "searching": false,
          "ordering": false,
          ...
          "ajax" : {
            "url" : global_url+"mrekapitulasi/kunjungan_rawat_inap/getData",
            "type" : "POST",
...
function exportExcel(){
    var urlDownload = global_url+"mrekapitulasi/kunjungan_rawat_inap/downloadExcel/";
    var kamar = $('#kamar').val();
