var base_url_modul = global_url+'data-rujukan/';
var infoTable = "";
$( document ).ready(function(){
    var data_grid = $('#table-data').DataTable({
          ...
          "processing" : true,
          "ajax" : {
            "url" : global_url+"mrekapitulasi/rekapitulasi_data_rujukan/getDataRujukan/",
            "type" : "POST",
...
function exportExcel(){
    var urlDownload = global_url+"mrekapitulasi/rekapitulasi_data_rujukan/downloadExcel/rekap-data-rujukan/";
    var id_pelayanan = 0;
