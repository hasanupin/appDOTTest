...
$( document ).ready(function(){
    var data_grid = $('#table-data').DataTable({
          ...
          "processing" : true,
          "ajax" : {
            "url" : global_url+"mrekapitulasi/data_penyakit_tertentu/getRekapPasienPenyakitEwars/",
            "type" : "POST",
...
function exportExcel(){
    var urlDownload = global_url+"mrekapitulasi/data_penyakit_tertentu/downloadExcel/";
