...
$( document ).ready(function(){
    var data_grid = $('#table-data-rekap-pekerjaan').DataTable({
           "paging": true,
          "lengthChange": false,
          "searching": false,
          "ordering": false,
          ...
          "processing" : true,
          "ajax" : {
            "url" : global_url+"mrekapitulasi/rekap_data_pekerjaan/getDataRekap/",
            "type" : "POST",
...
function exportExcel(){
    var urlDownload = global_url+"mrekapitulasi/rekap_data_pekerjaan/downloadExcel/";
...
function pdf(){
    var urlDownload = global_url+"mrekapitulasi/rekap_data_pekerjaan/downloadPdf/";
   var id_pelayanan = $('#cmbPoli').val();
     var jenis = $('#jenis').val();
    var start_date = $('#datepicker1').val();
    var end_date = $('#datepicker2').val();
